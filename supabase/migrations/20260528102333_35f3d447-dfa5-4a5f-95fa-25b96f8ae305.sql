...
REVOKE EXECUTE ON FUNCTION public.normalize_nigerian_phone(text) FROM PUBLIC;
...
BEGIN
  ...
  INSERT INTO public.withdrawals (
    ...
    _type,
    trim(coalesce(nullif(_full_name, ''), _profile_name)),
    _profile_phone,
    _email,
...
GRANT EXECUTE ON FUNCTION public.create_withdrawal_request(text, text, text, text, text, text, integer, text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.create_withdrawal_request(text, text, text, text, text, text, integer, text) TO service_role;