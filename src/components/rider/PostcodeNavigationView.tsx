...
function PostcodeNavigationViewInner({ lat, lng, postcode }: Props) {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* Map area — ALWAYS the same size (fills all remaining space below the
          header), whether the picker or the trip-in-progress sheet is
          showing. The sheet below floats on TOP of the map as an overlay
          instead of squeezing the map's container — Leaflet doesn't reliably
          notice its container being resized, so keeping the map's own size
          fixed avoids that entirely rather than working around it. */}
