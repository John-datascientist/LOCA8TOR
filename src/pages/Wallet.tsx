...
export default function Wallet() {
  ...
  // Returning from Stripe card checkout — the wallet is credited by the
  // stripe-webhook function, which can take a few seconds to arrive.
  useEffect(() => {
    const stripeStatus = searchParams.get('stripe');
    if (!stripeStatus) return;
    if (stripeStatus === 'success') {
      toast({ title: 'Payment received', description: 'Your wallet will show the new balance within a few seconds.' });
